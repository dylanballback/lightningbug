...
while True:
	...
	try:
	    ...
	    xmap = arduino_map(compAngleX, -90, 90, 150, 20)
	    ymap = arduino_map(compAngleY, -90, 90, 20, 150)
	    
	    # To give correct orentation
		

	    
	    #print("Angle X: " + str(xmap)+"   " +"Angle Y: " + str(ymap))
	    kit.servo[0].angle = ymap 
	    kit.servo[1].angle = xmap 
